...
auto main() -> int {
    ...
    cout << evaluate("-/221") << endl;
    cout << evaluate("5++66") << endl;
    cout << evaluate("*+123") << endl; 
    cout << evaluate("+*32-41") << endl; 
    cout << evaluate("/-842") << endl;
    cout << evaluate("/-*2213") << endl; 
    cout << evaluate("321-/--11-0+5*6/2+3//65") << endl; 
